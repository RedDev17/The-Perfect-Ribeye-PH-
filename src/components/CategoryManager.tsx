        ...
        <div className="max-w-2xl mx-auto px-4 py-8">
          <div className="bg-[#1a1a1a] rounded-xl shadow-lg p-8 border border-[#2a2a2a]">
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-[#f5f0e8] mb-2">Category Name *</label>
                <input
                  type="text"
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm font-medium text-[#f5f0e8] mb-2">Category ID *</label>
                <input
                  type="text"
                  value={formData.id}
              ...
              <div>
                <label className="block text-sm font-medium text-[#f5f0e8] mb-2">Icon *</label>
                <div className="flex items-center space-x-3">
                  <input
                    type="text"
                    value={formData.icon}
                    onChange={(e) => setFormData({ ...formData, icon: e.target.value })}
                    className="flex-1 px-4 py-3 bg-[#242424] border border-[#3a3a3a] rounded-lg text-[#f5f0e8] placeholder-gray-500 focus:ring-2 focus:ring-[#8b2635] focus:border-transparent"
                    placeholder="Enter emoji or icon"
                  />
                  <div className="w-12 h-12 bg-[#242424] rounded-lg flex items-center justify-center text-2xl border border-[#3a3a3a]">
                    {formData.icon}
                  </div>
                </div>
                <p className="text-xs text-gray-500 mt-1">
              ...
              <div className="flex items-center">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm font-medium text-[#f5f0e8]">Active Category</span>
                </label>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-[#0f0f0f]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-playfair font-semibold text-[#f5f0e8]">Manage Categories</h1>
            </div>
            <button
              onClick={handleAddCategory}
              className="flex items-center space-x-2 bg-[#242424] text-[#f5f0e8] px-4 py-2 rounded-lg hover:bg-[#2a2a2a] border border-[#3a3a3a] transition-colors duration-200"
            >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-[#1a1a1a] rounded-xl shadow-lg overflow-hidden border border-[#2a2a2a]">
          <div className="p-6">
            <h2 className="text-lg font-playfair font-medium text-[#d4a853] mb-4">Categories</h2>
                ...
                {categories.map((category) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="font-medium text-[#f5f0e8]">{category.name}</h3>
